          ...
          <div className="flex flex-col gap-1.5 text-left">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full px-4 py-2.5 pr-11 bg-gray-700 border border-gray-600 rounded-lg focus:outline-none focus:border-purple-500 text-white transition-all placeholder-gray-400"
              />
              <button
                type="button"
