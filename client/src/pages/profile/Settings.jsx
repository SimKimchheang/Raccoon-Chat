              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-800/50 border border-slate-700 rounded-lg p-6 hover:border-purple-500 transition-colors">
                ...
                <div className="mt-3 flex items-center gap-3">
                  <input 
                    ...
                    className="w-full rounded-xl border border-gray-600 bg-gray-800 px-4 py-3
                      text-white outline-none transition-all duration-200 focus:border-purple-500
                      focus:ring-2 focus:ring-purple-500/30 hover:border-gray-500"
                    />
                  <button
                    type="button"
